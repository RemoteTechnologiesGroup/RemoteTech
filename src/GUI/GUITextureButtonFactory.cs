    ...
    public static class GUITextureButtonFactory {
        ...
        private static GUIStyle CreateFromTextures(Texture2D texNormal, Texture2D texHover, 
            ...
            return new GUIStyle() {
                ...
                onNormal = new GUIStyleState() { background = texNormal, textColor = Color.white },
                onHover = new GUIStyleState() { background = texHover, textColor = Color.white },
                ...
                onFocused = new GUIStyleState() { background = texFocus, textColor = Color.white },
