...
namespace RemoteTech.Common.Settings
{
    public class CommonSettingsManager
    {
        ...
        public static CommonSettings Instance
        {
            get
            {
                ...
                return _instance = CommonSettings.Load();
            }
        }
        ...
        /// </summary>
        public static void ReloadSettings(CommonSettings previousSettings, string presetCfgUrl)
        {
            _instance = CommonSettings.LoadPreset(previousSettings, presetCfgUrl);
            _instance.Save();
        }
    }
    ...
    public class CommonSettings
    {
        ...
        public const string NodeName = "RemoteTechCommonSettings";
        public const string SaveFileName = "RemoteTech_CommonSettings.cfg";
        public const string DefaultSettingFileName = "Default_CommonSettings.cfg";
        ...
        public void Save()
        {
            try
            {
                ...
                CommonSettingsManager.OnSettingsSaved.Fire();
            }
            catch (Exception e)
            {
        ...
        public static CommonSettings Load()
        {
            ...
            CommonSettingsManager.OnSettingsLoaded.Fire();

            return settings;
        }

        private static void SearchAndPreparePresets(CommonSettings settings)
        {
        ...
        /// </summary>
        public static CommonSettings LoadPreset(CommonSettings previousSettings, string presetCfgUrl)
        {
            var newPreSetSettings = new CommonSettings();
