...
namespace RemoteTech.UI
{
    class OptionWindow : AbstractWindow
    {
        ...
        public OptionWindow()
            : base(new Guid("387AEB5A-D29C-485B-B96F-CA575E776940"), Localizer.Format("#RT_OptionWindow_title", RTUtil.Version),//"RemoteTech <<1>> Options"
        ...
        private void drawVisualStyleContent()
        {
            ...
            this.mSettings.ShowMouseOverInfoGroundStations = GUILayout.Toggle(this.mSettings.ShowMouseOverInfoGroundStations, (this.mSettings.ShowMouseOverInfoGroundStations) ?Localizer.Format("#RT_OptionWindow_VisualStyle_MouseOverInfoGroundStationsE") :Localizer
                .Format("#RT_OptionWindow_VisualStyle_MouseOverInfoGroundStationsD"));//"Mouseover of Ground Stations enabled" : "Mouseover of Ground Stations disabled"
            ...
            for(int i = presetList.Count - 1; i >= 0; --i)
            {
                GUILayout.BeginHorizontal("box", GUILayout.MaxHeight(15));
                {
                    ...
                    if(GUILayout.Button(Localizer.Format("#RT_OptionWindow_Presets_Reload"), this.mGuiListButton, GUILayout.Width(70), GUILayout.Height(20)))//"Reload"
                    {
                        ...
                        ScreenMessages.PostScreenMessage(Localizer.Format("#RT_OptionWindow_Presets_msg1", folderName), 10);//"Your RemoteTech settings are set to <<1>>"
