...
namespace RemoteTech.UI
{
    public class RoverFragment : IFragment
    {
        ...
        private void DrawTargetContent()
        {
            ...
            GUILayout.Label(new GUIContent(Localizer.Format("#RT_RoverFragment_ModeLabel", targetTypeString), tooltip));//"Mode: <<1>>
            ...
            GUILayout.BeginHorizontal();
            {
                ...
                GUILayout.Label(new GUIContent("(°)", Localizer.Format("#RT_RoverFragment_coordinations_desc", GameSettings.MODIFIER_KEY.name)), GUI.skin.textField, GUILayout.Width(40));//"Hold <<1>> and click on ground to input coordinates"
            }
            GUILayout.EndHorizontal();
